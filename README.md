...
| One sparse-history / newly-launched KPI scenario | ✅ | Activation Rate — AI Copilot: 12 days of history, confidence explicitly capped in `analysis/confidence.py`; also compared against a comparable-cohort benchmark rather than left as a bare low number — `KPIDetail.cohort_benchmark` |
